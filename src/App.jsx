...
import Layout from "./components/Layout"; // ใช้ Layout สำหรับโครงสร้างหลัก
import { AuthProvider } from "./context/AuthContext"; // จัดการ Auth และสถานะผู้ใช้
...
import ReportsAndAnalysis from "./page/ReportsAndAnalysis";
      ...
      <Router>
        <Routes>
          ...
          <Route element={<Layout />}>
            ...
            <Route path="/reports-and-analysis" element={<ReportsAndAnalysis />} />
          </Route>
        </Routes>
      </Router>
    </AuthProvider>
